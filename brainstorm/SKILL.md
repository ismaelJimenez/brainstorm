...
7. **Suggest next step** — recommend creating a specification from the brainstorm document.
...
flowchart TD
    ...
    M -- "approved" --> N(("Suggest next step"))
```
...
- "Create a specification from this brainstorm"
- "I'm done for now"
...
Do NOT suggest creating a specification for incomplete sessions. The brainstorm must be fully approved before transitioning to specification.
